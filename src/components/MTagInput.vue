  ...
  <div class="flex flex-col gap-1">
    ...
    >
      ...
      <button
        ...
        type="button"
        class="absolute right-2 flex h-6 w-6 cursor-pointer items-center justify-center rounded-full text-on-surface-variant transition-colors hover:bg-on-surface/8 hover:text-on-surface"
        :class="variant === 'filled' ? 'top-[57%] -translate-y-1/2' : 'top-[55%] -translate-y-1/2'"
